export const profile = {
  ...
  socials: [
    ...
    { label: "LinkedIn", href: "https://www.linkedin.com/in/enochweks/" },
  ],
};
...
export const projects = [
  {
    ...
    description:
      "A fast personal site for publishing work, writing case studies, and giving recruiters a direct path to contact.",
  ...
  },
  {
    ...
    description:
      "A focused operations dashboard that turns project status, metrics, and documents into a single workspace.",
  ...
  },
  {
    ...
    description:
      "A compact component library with reusable layout, typography, form, and navigation patterns.",
    stack: ["JavaScript", "CSS", "Docs"],
    href: "#contact",
  },
];
...
export const experience = [
  ...
  },
  {
    ...
    period: "2022 - 2024",
    description:
      "Built responsive interfaces, integrated APIs, and improved usability across web applications.",
  },
];
